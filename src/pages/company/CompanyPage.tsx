...
function CompanyPage() {
    const [selectedTab, setSelectedTab] = useState<"company" | "employee" | null>("company");
            ...
            <div>
                {Object.keys(departments).map((departmentName, index) => (
                    <div key={index}>
                        ...
                        <button onClick={() => handleConfirmDelete(departmentName)}>삭제</button>
                    </div>
                ))}
            </div>
        );
    ...
    const handleRegisterEmployee = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        if (!employeeName || !employeeEmail || !joinYear || !selectedDepartment || !employeeAnnualLeaveLimit) {
        ...
        try {
            ...
            handleShowAlert(error.message || "직원 등록 중 오류가 발생했습니다.", "error");
        }
    };
                    ...
                    <TabContainer darkMode={darkMode}>
                        <Setting darkMode={darkMode}>
                            <div className='page'>
                                ...
                                <p style={{ fontSize: "14px", marginBottom: "-10px" }}>부서 내역</p>
                                ...
                                <form onSubmit={handleRegisterEmployee}>
                                    ...
                                    <div className='inputBox2'>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setEmployeeAnnualLeaveLimit(e.target.value)}
                                        />
                                    </div>
