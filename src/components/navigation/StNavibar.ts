...
export const Wrap = styled.div<WrapProps>`
    ...
    margin-right: ${({ isSidebarOpen }) => (isSidebarOpen ? "0px" : "calc(100% - 80px)")};
    text-align: center;
...
export const Main = styled.button<MainProps>`
    ...
    box-shadow: ${({ $active }) => ($active ? "7px 7px 5px 0px rgba(0, 0, 0, 0.15)" : "none")};
    -webkit-box-shadow: ${({ $active }) => ($active ? "7px 7px 5px 0px rgba(0, 0, 0, 0.15)" : "none")};
    -moz-box-shadow: ${({ $active }) => ($active ? "7px 7px 5px 0px rgba(0, 0, 0, 0.15)" : "none")};
