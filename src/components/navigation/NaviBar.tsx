...
import { Cal, Fam, Ment, Main, Mypage, ProfileImg, Talk, Todo, NavBtn, Wrap, Log } from "./StNavibar";
...
function NaviBar({ isSidebarOpen, setIsSidebarOpen, mode }: NaviBarProps) {
    ...
    const hasAccessToOrganizationChart = user && (user.isEmployeeRegistered || user.company_code);
    const hasAccessToVacationRequest = user && (user.isEmployeeRegistered || user.company_code);
    ...
    }, [isLogin, user?.id, updateUserContext, state.mode]);
        ...
        <Wrap isSidebarOpen={isSidebarOpen} darkMode={darkMode}>
            ...
            {isSidebarOpen && (
                <>
                    ...
                    <ProfileImg src={profileImageUrl} className='p_img' alt='프로필 이미지' />
            ...
            <NavBtn>
                {mode === "IoMdPerson" && (
                    <>
                        ...
                        >
                            <Cal $active={activeMenu === "calendar"} isSidebarOpen={isSidebarOpen}>
                                <div>
                        ...
                        <Link
                            ...
                            style={{ width }}
                        >
                            <Mypage $active={activeMenu === "mypage"} isSidebarOpen={isSidebarOpen}>
                                <div>
                                    <LuUser size='25' />
                ...
                {mode === "FaPeopleGroup" && (
                    <>
                        <Link
                            ...
                            style={{ width }}
                        >
                            <Talk $active={activeMenu === "chart"} isSidebarOpen={isSidebarOpen}>
                                <div>
                        ...
                        <Link
                            ...
                            style={{ width }}
                        >
                            <Talk $active={activeMenu === "company"} isSidebarOpen={isSidebarOpen}>
                                <div>
                ...
                {isLogin ? (
                    <>
                        <Log onClick={() => setShowConfirm(true)} darkMode={darkMode} isSidebarOpen={isSidebarOpen}>
                            <ImExit size='20' />
